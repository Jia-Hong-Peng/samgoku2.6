...
<font color=white>歡迎。<BR>這兒賣著罕有的貴重書籍喲。<BR>現在$kname裝備的$proname2 可賣出<font color=red>$proval2</font> 金。<BR>本店有什麼可以幫忙客官呢？<BR></font>
</TD></TR></TABLE>
</TD></TR>
<TR><TD>
...
EOM
	...
	$list = "<TR><TD bgcolor=$TD_C1>選擇</TD><TD bgcolor=$TD_C2>名稱</TD><TD align=right bgcolor=$TD_C3>值段</TD><TD bgcolor=$TD_C2>效果</TD></TR>";
	$s_i=0;
	foreach(@PRO_DATA){
