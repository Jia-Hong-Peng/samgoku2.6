...
<TBODY><TR>
<TD BGCOLOR=$ELE_BG[$xele] WIDTH=100% height=5><div align="center"><font color=$ELE_C[$xele] size=4>＜＜<B> * $xname 會議室 *</B>＞＞</font></div></TD>
</TR><TR>
<TD height=5>
...
<TR><TD width="100%" bgcolor=$TALK_BG><div align="center"><font color=$TALK_FONT>本國專用的公告板。<BR>自國軍隊交流使用。</font></div></TD>
</TR>
</TBODY></TABLE>
</TD>
</TR>
...
<font color="#FFFFFF">主題：</font><input type=text name=title size=40><p>
<font color="#FFFFFF">內容：</font><textarea name=ins cols=40 rows=7>
...
<input type=hidden name=id value=$kid>
<input type=hidden name=pass value=$kpass>
<input type=submit value=\"次$BBS_NEXT_NUM件\">
</form>";
	}
print <<"EOM";
</CENTER>
